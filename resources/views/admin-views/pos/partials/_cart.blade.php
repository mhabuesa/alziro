...
<div id="cart">
    ...
    <div class="pt-4">
        <dl>
            ...
            <div class="d-flex gap-2 justify-content-between">
                <dt class="title-color text-capitalize font-weight-normal">Shipping Cost : </dt>
                <dd>
                    <input type="number" id="shippingCostInput" class="form-control w-25 float-end" name="shipping_cost" min="0" value="70" required>
                </dd>
            </div>
            ...
            <div class="d-flex gap-2 border-top justify-content-between pt-2">
                ...
                <dd class="font-weight-bold title-color" id="totalWithShipping">
        ...
        <div class="pt-4 mb-4">
            ...
            <ul class="list-unstyled option-buttons">
                ...
                <li>
                    ...
                    <label for="cod" class="btn btn--bordered btn--bordered-black px-4 mb-0">COD</label>
                </li>
                <li>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const totalDisplay = document.getElementById('totalWithShipping');

        // Original PHP total value (passed from server)
        const baseTotal = {{ round($cartItems['total'] + $cartItems['totalTax'] - $cartItems['couponDiscount'], 2) }};
