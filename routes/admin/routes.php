...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::post('AddNewCustomer', [CustomController::class, 'AddNewCustomer'])->name('AddNewCustomer');
    ...
    Route::post('customer/count', [CustomController::class, 'CustomerCount'])->name('customer.count');
    Route::post('multipleInvoice', [CustomController::class, 'multipleInvoice'])->name('multipleInvoice');
    Route::post('customer/update/{id}', [CustomController::class, 'customer_update'])->name('customer.update');
    Route::get('customer/import/form', [CustomController::class, 'customer_import_form'])->name('customer.import.index');
    ...
    // Bkash Route
    Route::get('nagad/refund/{paymentRefId}', [CustomController::class, 'nagad_refund']);
});
