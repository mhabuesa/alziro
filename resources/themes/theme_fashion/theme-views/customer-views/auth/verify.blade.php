                    ...
                    <div
                        ...
                        <div class="my-auto mx-auto">
                            <img loading="lazy" src="{{ theme_asset('assets/img/forget-pass/verification.png') }}"
                                class="mw-100 mb-auto d-none d-md-block" alt="{{ translate('icons') }}">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-md-10">
                            <div class="text-center d-flex flex-column align-items-center gap-3">
                                <img loading="lazy" width="46" src="{{ theme_asset('assets/img/icons/check.png') }}"
                                    class="dark-support" alt="{{ translate('user_verify') }}">
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-3">
                                    <button
                                        class="btn btn-base __btn-outline form-control w-auto min-w-180 resend-otp-button customer_login_register_modal">{{ translate('login') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
