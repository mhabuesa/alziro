                                        ...
                                        @else
                                            <div class="d-flex gap-10 justify-content-center">
                                                ...
                                                <form action="{{ route('admin.employee.delete') }}" method="post"
                                                    id="employee-delete-{{ $employee['id'] }}-form">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $employee['id'] }}">

                                                    <button type="button"
                                                        class="btn btn-outline-danger btn-sm delete-btn"
                                                        data-form-id="employee-delete-{{ $employee['id'] }}-form"
                                                        data-title="{{ translate('are_you_sure_you_want_to_delete_this_employee') }}?"
                                                        data-message="<p>{{ translate('this_action_is_irreversible') }}</p>">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deleteButtons.forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    let modalEl = document.getElementById("delete-confirm-modal");

                    // Set modal contents
                    modalEl.querySelector("#delete-modal-title").innerHTML = title;
                    modalEl.querySelector("#delete-modal-message").innerHTML = message;

                    // Confirm button submit action
                    modalEl.querySelector("#delete-modal-confirm-btn").onclick = function() {
