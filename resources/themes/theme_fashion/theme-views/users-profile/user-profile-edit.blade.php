                                ...
                                <form action="{{route('user-update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-4 ">
                                        <div class="col-sm-12 text-capitalize">
                                            ...
                                            <input type="text" value="{{$customerDetail['name']}}" name="name"
                                                   class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="tel" id="phone" name="phone" class="form-control"
                                                   ...
                                                   placeholder="{{translate('enter_phone_number')}}" readonly required>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form--label mb-2" for="email">{{ translate('email') }}</label>
                                            <input type="text" id="email" name="email" class="form-control"
                                                   value="{{$customerDetail['email']}}"
                                                   placeholder="{{translate('enter_email_adress')}}">
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <input type="address" name="address" id="address" class="form-control"
                                                   ...
                                                   placeholder="{{translate('enter_your_adress')}}">
                                        </div>
                                        <div class="col-sm-6">
