@foreach ($categoryWithProducts as $category)
    ...
    <div class="container">
        <div class="section-title pb-lg-1 text-capitalize">
            <div
                class="d-flex flex-wrap justify-content-between row-gap-2 column-gap-4 align-items-center single_section_dual_tabs">
                <h2 class="title mb-0">{{ $category->name }}</h2>
                <div
                    class="d-flex align-items-center column-gap-4 justify-content-end ms-auto ms-md-0 order-0 order-sm-2">
                                ...
                                @if ($product)
                                    ...
                                    <div class="product-card">
                                        <div class="img">
                                            ...
                                            <div
                                                class="hover-content d-flex justify-content-{{ $url == true ? 'between' : 'end' }}">
                                                @if ($url == true)
                                                    <a href="javascript:"
                                                ...
                                                <div class="d-flex flex-wrap column-gap-3">
                                                    ...
                                                    <a href="javascript:"
                                                        class="d-inline-flex wish-icon addCompareList_view_page"
                                                        data-id="{{ $product['id'] }}">
                                                        <i
                                                            class="bi bi-shuffle compare_list_icon-{{ $product['id'] }}"></i>
                                                    </a>
                                                    ...
                                                    @if ($url != true)
                                                        ...
                                                        @else
                                                            <span class="btn add-to-cart-plus-btn wish-icon">
                                                                ...
                                                                <form
                                                                    class="cart add-to-cart-form-{{ $product['id'] }}"
                                                                ...
                                                                <a href="javascript:"
                                                                    class="store_vacation_check_function"
                                                                    data-id="{{ $product['id'] }}"
                                        ...
                                        <div class="cont">
                                            ...
                                            <div
                                                class="d-flex flex-wrap row-gap-1 align-items-center column-gap-2 text-capitalize">
                                                <h4 class="price">
                                                ...
                                                @if ($product['product_type'] == 'physical')
                                                    @if ($product['current_stock'] <= 0)
                                                        <span
                                                            class="status text-danger">{{ translate('out_of_stock') }}</span>
