                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex gap-2">
                                ...
                                <select id="customer" name="customer_id" data-placeholder="Walking Customer"
                                    class="js-example-matcher form-control form-ellipsis action-customer-change js-customer-search">
...
@push('script_2')
    ...
    $(document).ready(function() {
        $('.js-customer-search').select2({
            placeholder: 'Search by phone...',
            minimumInputLength: 3, // কত অক্ষর লেখার পর search শুরু করবে
            ajax: {
                url: '{{ route("admin.pos.customer.search") }}', // এই route টা backend এ তৈরি করো
                dataType: 'json',
                delay: 250,
