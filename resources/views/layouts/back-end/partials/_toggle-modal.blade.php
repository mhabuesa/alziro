        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" id="toggle-modal-ok-button"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn--primary min-w-120" id="toggle-status-modal-ok-button"
                        data-dismiss="modal">{{ translate('ok') }}</button>
                    <button type="button" class="btn btn-danger-light min-w-120"
                        data-dismiss="modal">{{ translate('cancel') }}</button>
                </div>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                <div class="d-flex flex-column align-items-center text-center gap-2 mb-2">
                    ...
                    <div class="text-center" id="delete-modal-message"></div>
                </div>
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn-danger min-w-120" id="delete-modal-confirm-btn">
                        {{ translate('Delete') }}
                    </button>
