                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (Helpers::module_permission_check('order_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/orders*') ? 'active' : '' }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/orders/' . Order::LIST[URI] . '/review_to_deliver') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.orders.list', ['review_to_deliver']) }}"
                                            title="On Review">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                On Review
                                                <span class="badge badge-soft-warning badge-pill ml-1">
                                                    {{ \App\Models\Order::where(['order_status' => 'review_to_deliver'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                        ...
                        @if (Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/smsMarketing') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.smsMarketing') }}" title="SMS Marketing">
                                    <i class="tio-sms nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        SMS Marketing
                                    </span>
                                </a>
                        ...
                        @if (Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/customer/wallet*') || Request::is('admin/customer/' . Customer::LIST[URI]) || Request::is('admin/customer/' . Customer::VIEW[URI] . '*') || Request::is('admin/reviews*') || Request::is('admin/customer*') || Request::is('admin/customer/loyalty/' . Customer::LOYALTY_REPORT[URI]) ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/customer/wallet*') || Request::is('admin/customer/' . Customer::LIST[URI]) || Request::is('admin/customer/' . Customer::VIEW[URI] . '*') || Request::is('admin/reviews*') || Request::is('admin/customer*') || Request::is('admin/customer/loyalty/' . Customer::LOYALTY_REPORT[URI]) ? 'block' : 'none' }}">
                                    <li
                                        class="nav-item {{ Request::is('admin/customer/' . Customer::LIST[URI]) || Request::is('admin/customer/edit/*') || Request::is('admin/customer/' . Customer::VIEW[URI] . '*') ? 'active' : '' }}">
