                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6 title-color">
                                        <strong>-
                                            {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $extraDiscount), currencyCode: getCurrencyCode()) }}</strong>
                                    </dd>
                                    ...
                                    <dd class="col-sm-6 title-color">
                                        <strong>-
                                            {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $couponDiscount), currencyCode: getCurrencyCode()) }}</strong>
                                    </dd>
                                    ...
                                    @php($final_total = $total + $shipping - $extraDiscount - $couponDiscount)
                                    @if ($order['advanced'] == '1')
                                        <dt class="col-sm-5">Advanced Payment</dt>
                                        <dd class="col-6 title-color">
                                            <strong>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $final_total), currencyCode: getCurrencyCode()) }}</strong>
                                        </dd>
                                        <dt class="col-sm-5">{{ translate('total') }} (DUE)</dt>
                                        <dd class="col-6 title-color">
                                            <strong>৳0</strong>
                                        </dd>
                                    @else
            ...
            <div class="col-lg-4 col-xl-3">
                    ...
                    @if ($order->customer)
                        <div class="card-body">
                            <h4 class="mb-4 d-flex justify-content-between align-items-center gap-2">
                                ...
                                <span class="btn btn-outline-info btn-sm square-btn"><i
                                        class="tio-edit text-primary cursor-pointer fs-18" data-toggle="modal"
                                        data-target="#customerModal"></i></span>
                            </h4>
                        ...
                        <div id="customerModal" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <form action="{{ route('admin.customer.update', $order->customer_id) }}" method="post">
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title m-auto" id="exampleModalCenterTitle">Customer
                                        ...
                                        <div class="modal-body pb-0">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="address" class="form-control" id="" cols="35" rows="5" required>{{ $order->customer['street_address'] }}</textarea>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="">
                            <form action="{{ route('admin.orderInfoUpdate', $order->id) }}}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="status" class="form-label">Status</label>
                                    <select name="order_status" id="status" class="form-control">
                                        <option value="">Select Status</option>
                                        @if ($order->delivery_service_name == null)
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="scheduled_date" id="scheduled_delivery"
                                        value="{{ $order->scheduled_date }}" class="form-control">
                                </div>
                                <div class="mb-3">
